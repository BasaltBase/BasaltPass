                        ...
                        <div>
                          ...
                          <div className="flex">
                            <input
                              ...
                              value={secret}
                              readOnly
                              className="block w-full border-gray-300 rounded-l-md shadow-sm bg-gray-50 sm:text-sm"
                            />
                            <button
                              onClick={copySecret}
                              className="inline-flex items-center px-3 py-2 border border-l-0 border-gray-300 rounded-r-md bg-gray-50 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                              复制
                            </button>
                          </div>
