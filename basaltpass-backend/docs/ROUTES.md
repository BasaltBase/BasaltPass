...
| HEAD | /oauth/silent-auth |
| POST | /oauth/token |
| GET | /oauth/userinfo |
| HEAD | /oauth/userinfo |
| GET | /payment/checkout/:session_id |
| HEAD | /payment/checkout/:session_id |
| POST | /payment/simulate/:session_id |
